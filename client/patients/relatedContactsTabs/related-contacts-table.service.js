(function () {
    ...
    angular.module('gdCommon').factory('relatedContactsTableService', relatedContactsTableService);

    relatedContactsTableService.$inject = ['$filter', 'ngTableParams'];

    /* @ngInject */
    function relatedContactsTableService($filter, ngTableParams) {
        var table;
